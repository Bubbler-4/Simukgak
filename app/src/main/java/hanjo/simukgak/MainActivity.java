...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSelectCustomer(View view) {
       ...
       // Intent onSelectCustomerIntent = new Intent(this, CustomerActivity.class);
        Intent onSelectCustomerIntent = new Intent(this, LoginActivity.class);
    ...
    public void onSelectRestaurant(View view) {
       ...
       // Intent onSelectSellerIntent = new Intent(this, RestaurantMyPage.class);
        Intent onSelectSellerIntent = new Intent(this, LoginActivity.class);

        onSelectSellerIntent.putExtra("key", "value");
        onSelectSellerIntent.putExtra("Job",job);

        final int result = 1;
        startActivity(onSelectSellerIntent);
        //startActivityForResult(onSelectCustomerIntent, result);
    }
}
