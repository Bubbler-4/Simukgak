...
public class ReviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView jobTextView = (TextView) convertView.findViewById(R.id.textView4);
        ...
        // 아이템 내 각 위젯에 데이터 반영
        jobTextView.setText(review.getJob());
    ...
    public void addItem(String job, Drawable icon, String id, String s_n, String f_n, String n_l, String time, String grade, String comment) {
